        ...
        <div className={`rounded-2xl border ${isDark ? 'border-white/[0.08] bg-white/[0.03] backdrop-blur-xl shadow-2xl shadow-black/40' : 'border-gray-200 bg-white shadow-xl shadow-gray-200/50'} p-8 sm:p-10`}>
          ...
          {step === 'email' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div>
                <label htmlFor="otp" className={`block text-sm font-medium ${isDark ? 'text-slate-300' : 'text-gray-700'} mb-2`}>
                  Verification Code
                </label>
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                    <KeyRound className={`w-4 h-4 ${isDark ? 'text-slate-500' : 'text-gray-400'}`} />
                  </div>
                  <input
                    id="otp"
                    name="otp"
              ...
              <button
                ...
                className={`w-full text-sm font-medium ${isDark ? 'text-slate-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'} transition-colors`}
              >
                Change email
              </button>
            </form>
          ...
          <div className="mt-6 text-center">
            <Link to="/login" className={`text-sm font-medium ${isDark ? 'text-slate-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'} transition-colors inline-flex items-center gap-2`}>
