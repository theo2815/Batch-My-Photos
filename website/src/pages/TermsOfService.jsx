      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="rounded-xl border p-6 sm:p-8 bg-bg-surface/50 border-border-subtle">
          <div className="space-y-5">
            ...
            <div>
              <h4 className="text-sm font-display font-semibold mb-2 text-text-primary">Your responsibility</h4>
            ...
            <div>
              <h4 className="text-sm font-display font-semibold mb-2 text-text-primary">Limitation of liability</h4>
            ...
            <div>
              <h4 className="text-sm font-display font-semibold mb-2 text-text-primary">Changes to terms</h4>
            ...
            <div>
              <h4 className="text-sm font-display font-semibold mb-2 text-text-primary">Contact</h4>
