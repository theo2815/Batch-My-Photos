  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-bg-main overflow-hidden px-4 py-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="hero-orb-1 absolute top-1/4 -right-32 w-96 h-96 rounded-full blur-3xl bg-primary/15" />
        <div className="hero-orb-2 absolute bottom-1/4 -left-32 w-96 h-96 rounded-full blur-3xl bg-accent/15" />
        ...
        <div className="rounded-2xl border border-border-subtle bg-bg-surface backdrop-blur-xl shadow-2xl shadow-black/30 p-8 sm:p-10">
          ...
          {success ? (
            <div className="text-center">
              <div className="mx-auto w-12 h-12 rounded-full flex items-center justify-center mb-4 bg-emerald-500/20 text-emerald-400">
