      ...
      <div className="auth-card-in relative z-10 w-full max-w-md">
        <div className="rounded-2xl border border-border-subtle bg-bg-surface backdrop-blur-xl shadow-2xl shadow-black/30 p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-text-secondary">Make sure it's secure</p>
          </div>

          {/* Success State */}
          {success ? (
            <div className="text-center">
              <div className="mx-auto w-12 h-12 rounded-full flex items-center justify-center mb-4 bg-emerald-500/20 text-emerald-700">
                <CheckCircle className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-medium mb-2 text-text-primary">Password updated!</h3>
              <p className="text-sm mb-8 text-text-secondary">
                Your password has been changed successfully.
              </p>
              <Link
                href="/login"
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-white hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 transition-all duration-200 active:scale-[0.98] cursor-pointer"
              >
